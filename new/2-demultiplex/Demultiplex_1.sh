...
#SBATCH -p bigmemm
module load perl
cat plate12_R1.fastq.gz | /home/makman/ProSNP/fastx_barcode_splitter.pl --bcfile /home/makman/ProSNP/demultiplex/barcodes_plate12.txt --bol --prefix ProSNP12_ --suffix _R1.fastq --mismatches 1 | gzip
cat plate12_R2.fastq.gz | /home/makman/ProSNP/fastx_barcode_splitter.pl --bcfile /home/makman/ProSNP/demultiplex/barcodes_plate12.txt --bol --prefix ProSNP12_ --suffix _R2.fastq --mismatches 1 | gzip
