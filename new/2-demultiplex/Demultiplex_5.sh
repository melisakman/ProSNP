...
#SBATCH -J Demul5
#SBATCH -o /home/makman/ProSNP/outs/demultiplex5.out
#SBATCH -e /home/makman/ProSNP/outs/demultiplex5.err
...
zcat ../NYU/ma_4_NoIndex_L004_R1_001.fastq.gz | /home/makman/ProSNP/fastx_barcode_splitter.pl --bcfile /home/makman/ProSNP/demultiplex/barcodes_plate5_ma4.txt --bol --prefix ProSNP5_ma4_ --suffix _R1.fastq --mismatches 1 | gzip
zcat ../NYU/ma_4_NoIndex_L004_R2_001.fastq.gz | /home/makman/ProSNP/fastx_barcode_splitter.pl --bcfile /home/makman/ProSNP/demultiplex/barcodes_plate5_ma4.txt --bol --prefix ProSNP5_ma4_ --suffix _R2.fastq --mismatches 1 | gzip
