...
#SBATCH -J Demul4
#SBATCH -o /home/makman/ProSNP/outs/demultiplex4.out
#SBATCH -e /home/makman/ProSNP/outs/demultiplex4.err
...
zcat ../NYU/ma_3_NoIndex_L003_R1_001.fastq.gz | /home/makman/ProSNP/fastx_barcode_splitter.pl --bcfile /home/makman/ProSNP/demultiplex/barcodes_plate5_ma3.txt --bol --prefix ProSNP5_ma3_ --suffix _R1.fastq --mismatches 1 | gzip
zcat ../NYU/ma_3_NoIndex_L003_R2_001.fastq.gz | /home/makman/ProSNP/fastx_barcode_splitter.pl --bcfile /home/makman/ProSNP/demultiplex/barcodes_plate5_ma3.txt --bol --prefix ProSNP5_ma3_ --suffix _R2.fastq --mismatches 1 | gzip
